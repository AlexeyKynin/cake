...
<!--<!--<section class="s-dignity" id="s-dignity" style="background-image: url(img/dignity_fon.jpg)">-->-->
<!--<section class="s-dignity" id="s-dignity">-->
<!--	<div class="s-dignity-body" id="s-dignity-body" style="background: url(img/fon_catalog.png) 0 0 repeat">-->
<!--		<!--<div class="s-dignity-body-content">-->-->
<!--		<div class="container">-->
<!--			<div class="row">-->
<!--				<div class="col-md-4">-->
<!--					<div class="s-dignity-body-element">-->
<!--						<img class="s-dignity-body-element-img" src="img/dignity/003-vegetables.svg" alt="Натуральные продукты">-->
...
<!--				<div class="col-md-4">-->
<!--					<div class="s-dignity-body-element">-->
<!--						<img class="s-dignity-body-element-img" src="img/dignity/002-tray.svg" alt="С любовью">-->
<!--						<div class="s-dignity-body-element-text">-->
...
<!--				<div class="col-md-4">-->
<!--					<div class="s-dignity-body-element">-->
<!--						<img class="s-dignity-body-element-img" src="img/dignity/001-cake.svg" alt="Уникальные торты">-->
<!--						<div class="s-dignity-body-element-text">-->
...
<!--<section class="s-reviews" style="background: url(img/fon_catalog-ping2.png) 0 0 repeat">-->
<!--	<div class="container">-->
<!--		<div class="row">-->
<!--			<div class="col-md-12">-->
...
<!--					<div class="review" style="background: url(img/fon_catalog.png) 0 0 repeat">-->
...
<!--		<div class="row">-->
<!--			<div class="col-md-12">-->
<!--				<div class="s-reviews-button">Оставить отзыв</div>-->
<!--			</div>-->
<!--		</div>-->
<!--	</div>-->
<!--</section>-->
